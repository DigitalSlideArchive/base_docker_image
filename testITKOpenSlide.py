...
class TestITKOpenSlide(unittest.TestCase):
    ...
    def test_tiff(self):
        ...
        imgLoc = 'https://data.kitware.com/api/v1/file' \
                 '/57a35fa38d777f126827a710/download'
        cwd = os.getcwd()
    ...
    def test_svs(self):
        imgName = 'TCGA-CV-7242-11A-01-TS1.1838afb1-9eee-4a' \
                  '70-9ae3-50e3ab45e242.svs'
        imgLoc = 'https://data.kitware.com/api/v1/file/' \
                 '57a3519e8d777f126827a679/download'
        cwd = os.getcwd()
        wget.download(imgLoc, out=cwd + '/test', bar=None)
        self.OpenSlideITKRead('dsarchive/base_docker_image', imgName,
                              'out2.jpg')
    ...
    def checkType(self, imgName, header):
        ...
        img = imgFile.read(4)
        self.assertIsInstance(img, six.binary_type,
                              "image %s is not being read as a"
                              " bytes object" % imgName)
